...
Public Class CriptaFiles
	...
	Public Function EncryptFile(ByVal password As String, ByVal _
		in_file As String, ByVal out_file As String) As String
		Return CryptFile(password, in_file, out_file, True)
	End Function

	Public Function DecryptFile(ByVal password As String, ByVal _
		in_file As String, ByVal out_file As String) As String
		Return CryptFile(password, in_file, out_file, False)
	End Function

	Public Function CryptFile(ByVal password As String, ByVal _
		...
		Using in_stream As New FileStream(in_file,
			...
			Using out_stream As New FileStream(out_file,
				...
				' output stream.
				ritorno = CryptStream(password, in_stream, out_stream,
					encrypt)
			End Using
		End Using
	...
	Private Function CryptStream(ByVal password As String, ByVal _
